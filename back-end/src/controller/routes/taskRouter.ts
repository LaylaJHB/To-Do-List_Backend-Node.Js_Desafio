...
taskRouter.delete("/deleteTaskById/:id", (req, res) => taskController.deleteTaskById(req, res))
taskRouter.post("/updateTaskById", (req, res) => taskController.updateTaskById(req, res))